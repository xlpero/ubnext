  ...
  Drupal.behaviors.ubn_startpage_blurbs_navigation_show_more = {
    attach: function(context, settings) {
      ...
      $('.blurb-navigation', context).each(function() {
        $this = $(this);
        $blurb_container = $this.closest('.blurb-navigation');
        ...
        if ($extra_items.length) {
          ...
          $show_more_link.click(function() {
            ...
            if ($blurb_container.hasClass('expanded')) {
              ...
              $blurb_container.addClass('expanded');
            }
